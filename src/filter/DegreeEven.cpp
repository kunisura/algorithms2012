 ...
 * $Id: DegreeEven.cpp 9 2011-11-16 06:38:04Z iwashita $
 */

#include "DegreeEven.hpp"

#include <cassert>

int DegreeEven::down(bool take, int fromIndex, int toIndex) {
